...
import { X, Save, User, Phone as PhoneIcon, Tag, Instagram, Briefcase, CreditCard, Thermometer, Palette, Link2, CalendarHeart, Plus, Trash2 } from 'lucide-react';
  ...
  useEffect(() => {
    if (customer) {
        setFormData({
            ...
            temperature: customer.temperature || 'morno',
            styles: customer.styles || [],
            moodboardUrl: customer.moodboardUrl || '',
